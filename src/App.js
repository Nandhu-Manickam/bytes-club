          ...
          <Switch>
            <Route exact path="/">
              <nav class="navbar navbar-expand-lg navbar-dark dark fixed-top">
                <div class="container">
                  <a class="navbar-brand"><div onClick={this.onHome}>Bytes Club</div></a>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner e-slider">
                        <div class="carousel-item active">
                          <img class="d-block w-100" src={require('./image/slide2.png')} alt="First slide" />
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src={require('./image/slide1.png')} alt="Second slide" />
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src={require('./image/slide3.png')} alt="Third slide" />
                        </div>
                      </div>
